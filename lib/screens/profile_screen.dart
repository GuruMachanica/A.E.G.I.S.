...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'No cloud login or account required. All data stays local.',
                                style: GoogleFonts.rajdhani(
                                  color: textSecondary,
                                  fontSize: 11,
                                ),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      icon: const Icon(Icons.refresh_rounded, size: 18, color: accentCyan),
                      onPressed: () => _confirmResetLocalCache(context, ref),
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(
  ...
  void _confirmResetLocalCache(BuildContext context, WidgetRef ref) {
    showDialog(
      context: context,
      builder: (_) => _AegisDialog(
        title: 'Reset Local Threat Cache?',
        message: 'This will flush transient in-memory speech buffers and restart the local neural DSP engine.',
        ...
        onConfirm: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              backgroundColor: bgSurface,
              content: Text(
                'Local threat cache successfully flushed.',
